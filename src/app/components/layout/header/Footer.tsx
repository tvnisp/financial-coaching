...
export function Footer() {
	...
	return (
		<footer className='text-brandBlue bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8'>
			<div className='gap-6 justify-between md:flex'>
				<div className='flex-1'>
					<div className='max-w-xs'>
						...
						>
							<Image
								src='/assets/RamseyPreferredCoach.png'
								width={150}
								height={26}
								alt='logo'
							/>
			...
			<div className='mt-8 py-6 border-t items-center justify-between sm:flex'>
				<div className='mt-4 sm:mt-0'>
					&copy; {year} Trusted Financial Coaching All rights
					reserved.
				</div>
